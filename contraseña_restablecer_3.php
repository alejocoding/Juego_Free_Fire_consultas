    ...
    <div class="contenido_grid">
        ...
        <div class="seccion">
            ...
            <form action="" method= "POST" enctype = "multipart/form-data" class="formulario">
                ...
                <input type="password" class="datos" id="new_contraseña" name="new_contraseña" required>
                <span></span>

                <label for="confirmar_con">Confirmar Contraseña:*</label>
                <input type="password" class="datos" id="confirmar_con" name="confirmar_con" required>
                <span></span>
