...
$batalla = $con->prepare("INSERT INTO batalla (id_sala,id_perdedor) VALUES (:sala,:user)");
$batalla->bindParam("sala",$id_sala,PDO::PARAM_INT);
$batalla->bindParam("user",$usuario,PDO::PARAM_INT);
$batalla->execute();

$perdedor = $con->prepare("INSERT INTO reporte_usuario (id_usuario, partidas_jugadas, partidas_ganadas)
            VALUES (:user, 1, 0)
            ON DUPLICATE KEY UPDATE  
            partidas_jugadas = partidas_jugadas + 1");
$perdedor->bindParam(":user",$usuario,PDO::PARAM_INT);
$perdedor->execute();
...
<body>
    ...
    <div class="alerta">
        <img src="../img/defeat.png" alt="Perdedor" class="icono">
        <h2>¡Has perdido!</h2>
