...
$partidas = $con->prepare("SELECT * FROM batalla INNER JOIN salas  USING(id_sala) INNER JOIN mapas USING(id_mapa) WHERE id_ganador = :user or id_perdedor = :user2 ORDER BY id_batalla DESC;");
